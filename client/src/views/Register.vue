...
const handleRegister = async () => {
    try {
        ...
        await authStore.register(formUser.value.username, formUser.value.password)
    ...
    <div class="flex justify-center items-center h-screen">
        <div class="shadow-md bg-white rounded-md m-5 p-10">
            ...
            <div class="flex justify-end mt-4">
                <button @click="handleRegister" class="p-2 px-5 bg-blue-500 shadow-md rounded-md hover:bg-blue-700 hover:text-white duration-200">Register</button>
            </div>
